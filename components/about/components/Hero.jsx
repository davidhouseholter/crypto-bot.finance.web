  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        You get hassle-free automated without worrying about any technical indicators or constantly watching the market status.
      </p>
      {/* <div className="mt-10 flex justify-center gap-x-6">
        <Button href="/sign-up">Get 6 months free</Button>
        <Button
      ...
      <div className="mt-36 lg:mt-44">
        ...
        >
          {[
            [
              { name: 'Coinbase', logo: logoCoinbase },
            ],
            [
            ...
            [
              { name: 'Kubernetes', logo: logoK8s },
            ]
          ].map((group, groupIndex) => (
            <li key={groupIndex} style={{ maxWidth: '150px' }}>
              <ul
                role="list"

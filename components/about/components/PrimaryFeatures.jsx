...
const features = [
  ...
  },
  {
    ...
    description:
      "You can trade any currency your exchange provides and create as many trade bots for any assets pairs and multiple bots of the same asset pair.",
    image: screenshotTradeBotList,
  },
  {
    title: 'Details',
    description:
...
export function PrimaryFeatures() {
  ...
  return (
    <section
      id="features"
      aria-label="Features for running your trade bots"
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            Everything you need to simply invest your money.
          </h2>
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            We made the computers and algorythims watch the markets and do most the work so you can sit back and enjoy a mai tai.
          </p>
        </div>
        <Tab.Group
          as="div"

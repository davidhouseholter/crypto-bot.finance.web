...
export default function AddTradeWalletModal({  setShowModal }) {
  const open = true;
  const exchanges = [
    {
      id: 1,
  ...
  const addWalletType = (exchange) => {
    ...
    tradeWalletData.exchangeType = exchange.exchangeType;
    return true;
  };
                  ...
                  <div className="flow-root mt-6">
                    <ul role="list" className="-my-5 divide-y divide-gray-200">
                      {exchanges.map((exchange) => (
                        <li key={exchange.id} className="py-4">
     ...
     >
       View all
                ...
                <>
                  ...
                  <div className="mt-4">
                    {currentExchange.exchangeType ==
                      WalletConfigExchangeType.ApiKey && <>Conbase</>}
                    {currentExchange.exchangeType ==
              ...
              <div className="mt-5 sm:mt-6">
                ...
                {tradeWalletData.exchangeType !=
                WalletConfigExchangeType.None && (
                <button

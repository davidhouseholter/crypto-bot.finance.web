      ...
      <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-4 pt-10 lg:px-40 bg-blue-50 dark:bg-blue-900 md:h-96">
        <div className="mx-auto mb-10 md:mt-20">
          ...
          <p className="text-sm text-gray-700 mt-4 font-light dark:text-gray-200">
           Contact me with your inquiries. Its a wonderful to get a hold of you.
          </p>
        </div>
        <form
        ...
        >
          ...
          <div className="flex flex-row items-center justify-start">
            <button
              type="submit"
              className="px-10 mt-8 py-2 bg-brand-primary text-gray-50 font-light rounded-md text-lg flex flex-row items-center"
            >
              {buttonText}

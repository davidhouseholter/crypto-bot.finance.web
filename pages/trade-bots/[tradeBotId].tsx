...
export default function TradeBotDetails() {
  ...
  // console.log('currentSession', botDetails?.currentSession)
  // console.log('lastOrder', botDetails?.lastOrder)
  const tradeBots = useSelector((state: any) => state.userTradeBostMode.value);
  ...
  useEffect(() => {
    ...
    if (tradeBotDetails != null && tradeBotDetails.id == tradeBotId) {
      ...
      setTradeBotOrders(tradeBotDetails);
    } else {
      fetchTradeBotData();
    }
  }, [tradeBotId]);
                ...
                <div className="sm:col-span-1">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    <p>
                      ...
                      {botDetails.currentSession?.peakPrice.toFixed(2)})
                    </p>
                    <p>
                      Allowance:{" "}
